...
export const ScaleIcon: React.FC<ScaleIconProps> = ({ difficulty }) => {
   
  switch (difficulty) {
    case "начальный":
      return <img src="/image/beginner.svg" alt="Начальный уровень" />;
    case 'средний':
      return <img src="/image/middle.svg" alt="Средний уровень" />;
    case 'сложный':
      return <img src="/image/hard.svg" alt="Сложный уровень" />;
    default:
      return null;
  }
};

interface IconOverPicProps {
  Icon: React.ReactElement;
  children: React.ReactNode;
}

export const IconOverPic: React.FC<IconOverPicProps> = ({ Icon, children }) => {
  return (
